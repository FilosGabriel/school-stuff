...
public class ClassroomController {
    ...
    @GetMapping("/code/{id}/{date}")
    public String code(@PathVariable("id") final String id,@PathVariable("date") final String date, Model model) {
        var code = presenceService.makePresence(id,date);
