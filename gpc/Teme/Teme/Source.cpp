...
void drawnHexagon(float red,float green,float blue,float radius) {
    glColor3f(red, green, blue); // rosu
    glBegin(GL_POLYGON);
    glVertex2f(-0.4 * radius, -0.8 * radius);
    glVertex2f(-0.8 * radius, 0 * radius);
    glVertex2f(-0.4 * radius, 0.8 * radius);
    glVertex2f(0.4 * radius, 0.8 * radius);
    glVertex2f(0.8 * radius, 0 * radius);
    glVertex2f(0.4 * radius, -0.8 * radius);
...
void Display8() {
    ...
    // de completat ...
    drawnHexagon(0.f, 0.f, 1.f, 1);
    drawnHexagon(1.f, 0.f, 0.f, 0.7);
    drawnHexagon(255.f, 255.f, 255.f, 0.6);
